Este repositório são anotações e práticas com a linguagem Java.
...
Como está organizado tudo?
    ...
    3 - Dentro de cada pasta haverá um arquivo .java e um .txt onde ficará anotado códigos
        praticados e anotações consecutivamente;
