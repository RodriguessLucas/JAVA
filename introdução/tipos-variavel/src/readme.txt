Tipos e variaveis:
    ...
    Explorar os tipos de dados númericos, lógicos, caracteres 
    ...
    OBS:
        - Apesar o float ocupar metate da memoria consumida do que o tipo double,
        ele é menos ultilizado. Ele sofre uma limitação que compromete seu
        uso em determinada situações: somente mantém uma precisão decimal entre
        6 e 7 dígitos.

        - Da mesma forma o tipo long, é comum ultilizar o int pois já satisfaz
        a maioria dos problemas.

        - sempre no tipo float termine a atribuição com F, para que entenda q é decimal
            flaot pi = 3.14F;
    ...
    Casting: conversão entre tipos que de maior capacidade de armazenamendo para
    menor. exemplo: de int para short
    shor valor = (short) idade;
    ...
    Variaveis e constantes:
        ...
        Variveis são valores armazenados na memória que podem ser modificados
        depois de declarados.
